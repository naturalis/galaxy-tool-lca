...
Of all the blast hits a sub-selection made of the top hits based on a percentage of the bitscore. If the top percentage is set to 8% you do 0.92\*bitscore best hit=top treshold. In this example all hits with a bitscore above 294.4 will continue to the next step.   
